...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("abhineetpal63@gmail.com");
    setHasCopied(true);
      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              <p className="grid-headtext">Hi, I'm Abhineet Pal</p>
          ...
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                ...
                technologies, proficient in JavaScript, TypeScript and Python. I build robust applications using React, with experience in Node.js, Express, and MongoDB.
                 I deliver engaging, scalable
